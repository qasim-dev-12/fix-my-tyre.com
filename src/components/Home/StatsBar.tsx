  ...
  return (
    <section className="bg-gray-light py-10 dark:bg-bg-color-dark">
      <div className="container">
        <h2 className="mb-8 text-center text-2xl font-bold leading-tight text-white sm:text-3xl md:text-4xl">
          Trusted by Drivers Across Dubai
        </h2>
        <div className="grid grid-cols-2 gap-3 sm:gap-6 md:grid-cols-4">
          {stats.map((stat, i) => (
            ...
            >
              <span className="icon-pulse flex h-9 w-9 items-center justify-center rounded-full bg-primary/10 ring-1 ring-primary/30 transition-colors duration-300 group-hover:bg-primary/20 sm:h-12 sm:w-12">
